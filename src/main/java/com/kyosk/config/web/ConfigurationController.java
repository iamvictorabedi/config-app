...
public class ConfigurationController {
    ...
    public List<ConfigResponseDto> updateConfiguration(@PathVariable final String name, final ConfigRequestDto configRequestDto) {
    ...
    public List<ConfigResponseDto> removeConfiguration(@PathVariable final String name) {
        log.debug("Request to delete config: {} has being received", name);
        return service.removeConfig(name);
    }
}
